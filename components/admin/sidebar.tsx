...
const menuItems = [
  ...
  { href: "/admin/payouts", label: "تسویه‌ها", icon: Wallet },
...
export function AdminSidebar() {
  ...
  return (
    <>
      <div className="relative z-40 md:hidden border-b border-border/50 bg-white/70 backdrop-blur-[12px] p-4 flex items-center justify-between shadow-sm ring-1 ring-black/5">
        <button
          type="button"
      ...
      <Sheet open={isOpen} onOpenChange={setIsOpen}>
        <SheetContent
          ...
          className="md:hidden w-72 max-w-[85%] bg-white/80 backdrop-blur-[12px] border-l border-border/50 p-5 shadow-sm ring-1 ring-black/5"
        >
