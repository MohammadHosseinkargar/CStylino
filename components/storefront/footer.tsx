...
export function Footer() {
  return (
    <footer className="border-t border-border/30 bg-muted/20 mt-auto">
      <PageContainer className="pt-20 pb-28 md:pb-20">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex items-start gap-3 text-muted-foreground">
                ...
                <span>{fa.footer.phone}</span>
              </li>
              <li className="flex items-start gap-3 text-muted-foreground">
                <Mail className="h-4 w-4 mt-0.5 flex-shrink-0" />
                <span>{fa.footer.email}</span>
              </li>
              <li className="flex items-start gap-3 text-muted-foreground">
        ...
        <div className="mt-16 pt-8 border-t border-border/30 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground text-center md:text-right">
            © {new Date().getFullYear().toLocaleString("fa-IR")} {fa.footer.rights}
          </p>
